                                        ...
                                        <tbody>
                                            ...
                                            <?php foreach ($token as $t) : ?>
                                                <tr>
                                                    <td><?= $i; ?></td>
                                                    <td><?= $t->whatsapp; ?><br>
                                                        <a target="_blank" href="https://api.whatsapp.com/send?phone=&text=*TAUTAN%20PENDAFTARAN*%0A%0ALink%3A%20%0A%60%60%60<?= urlencode(site_url('paspor/reg?no=' . $t->whatsapp . '&token=' . urlencode($t->token))); ?>%60%60%60%0A%0A%60%60%60*Tautan%20ini%20berisi%20token%20pendaftaran%20dan%20bersifat%20rahasia.*%60%60%60" class="badge badge-success">Kirim ke Peserta</a>
                                                    </td>
